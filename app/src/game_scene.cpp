...
std::shared_ptr<e::Node> GameScene::Build() {
...
std::shared_ptr<eui::Layout> GameScene::BuildUIMenu() {
...
std::shared_ptr<e::Node> GameScene::BuildUINode() {
...
std::shared_ptr<e::Node> GameScene::BuildEcsNode() {
...
void GameScene::CreateRedPlayer(ecs::World& world) {
...
void GameScene::CreateBluePlayer(ecs::World& world) {
    const auto entity = world.CreateEntity();
...
void GameScene::CreateBall(ecs::World& world) {
    const auto entity = world.CreateEntity();
...
void GameScene::CalcWorldBounds(
  const std::shared_ptr<e::WindowSystem>& windowSystem,
